...
public class Chocolate extends JFrame implements ActionListener{
    BascketManager bascketManager = BascketManager.getInstance();
    Product chac1 = new Product("Candy chocolate",7.00);
    Product chac2 = new Product("Sweet chocolate",10.20);
    Product chac3 = new Product("Chocolate",12.25);
    Product chac4 = new Product("Nutty chocolate",7.60);
    Product chac5 = new Product("Small chocolate cake",14.20);
    Product chac6 = new Product("Chocolate fruit",9.99);
...
//  for mainpanel-------------------------------------------------------------------------------------------------------
    ...
    ImageIcon candy1 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\still-life-cup-brazilian-acai-dessert.jpg");
    ImageIcon candy2 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\some-chocolates-ai-generated-image.jpg");
    ImageIcon candy3 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\pexels-pixabay-65882.jpg");
    ImageIcon candy4 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\pushpak-dsilva-r-hQw_obFd0-unsplash.jpg");
    ImageIcon candy5 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\vecteezy_decadent-chocolate-layered-cake_52147459.jpg");
    ImageIcon candy6 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\vecteezy_luxurious-chocolate-assortment-with-fresh-raspberries_60847514.jpg");
    ...
    JLabel l_candy1 = new JLabel("PRICE : $7.00");
    JLabel l_candy2 = new JLabel("PRICE : $10.20");
    JLabel l_candy3 = new JLabel("PRICE : $12.25");
    JLabel l_candy4 = new JLabel("PRICE : $7.60");
    JLabel l_candy5 = new JLabel("PRICE : $14.20");
    JLabel l_candy6 = new JLabel("PRICE : $9.99");
...
//        //-------------------------------------------------------------------
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==but_candy1){
            bascketManager.addproduct(chac1);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_candy2){
            bascketManager.addproduct(chac2);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_candy3){
            bascketManager.addproduct(chac3);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_candy4){
            bascketManager.addproduct(chac4);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_candy5){
            bascketManager.addproduct(chac5);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_candy6){
            bascketManager.addproduct(chac6);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
    }
}
