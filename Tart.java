...
public class Tart extends JFrame implements ActionListener{
    BascketManager bascketManager = BascketManager.getInstance();
    Product tart1 = new Product("Orange tart",8.30);
    Product tart2 = new Product("Pie",10.20);
    Product tart3 = new Product("Apple tart with cream",9.25);
    Product tart4 = new Product("Strawberry tart",7.60);
    Product tart5 = new Product("Chocolate pie",6.20);
    Product tart6 = new Product("Pineapple pie",8.99);
...
//  for mainpanel-------------------------------------------------------------------------------------------------------
    ...
    ImageIcon sweet1 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\f.jpg");
    ImageIcon sweet2 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\e.jpg");
    ImageIcon sweet3 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\a.jpg");
    ImageIcon sweet4 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\d.jpg");
    ImageIcon sweet5 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\b.jpg");
    ImageIcon sweet6 = new ImageIcon("D:\\Papp\\intlij\\IntelliJ IDEA Community Edition 2025.1\\PICS\\c.jpg");
    ...
    JLabel l_sweet1 = new JLabel("PRICE : $8.30");
    JLabel l_sweet2 = new JLabel("PRICE : $10.20");
    JLabel l_sweet3 = new JLabel("PRICE : $9.25");
    JLabel l_sweet4 = new JLabel("PRICE : $7.60");
    JLabel l_sweet5 = new JLabel("PRICE : $6.20");
    JLabel l_sweet6 = new JLabel("PRICE : $8.99");
...
//        //-------------------------------------------------------------------
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==but_sweet1){
            bascketManager.addproduct(tart1);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_sweet2){
            bascketManager.addproduct(tart2);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_sweet3){
            bascketManager.addproduct(tart3);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_sweet4){
            bascketManager.addproduct(tart4);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_sweet5){
            bascketManager.addproduct(tart5);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
        if (e.getSource()==but_sweet6){
            bascketManager.addproduct(tart6);
            JOptionPane.showMessageDialog(this, "Added to basket!");
        }
    }
}
